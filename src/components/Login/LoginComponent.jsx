            ...
            <div className="w-full max-w-md p-8 space-y-6 my-9 bg-gray-100 shadow-md rounded-lg">
                ...
                <form className="space-y-8">
                    <div>
                        ...
                        <input type="email" className="w-full p-2 mt-1 border rounded-md" placeholder="example@email.com" />
                    </div>
                    <div>
                        <label className=" text-lg font-medium text-gray-700">Password</label>
                        <input type="password" className="w-full p-2 mt-1 border rounded-md" placeholder="Enter your password" />
                    </div>
                    <div className='text-center'>
                        <button type="submit" className="p-3 text-white  bg-green-700 rounded-md hover:bg-green-600">Sign Up</button>
                    </div>
                </form>
                <div className="mt-6">
